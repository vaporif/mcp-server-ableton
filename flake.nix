{
  ...
  in {
    ...
    overlays.default = final: _prev: {
      mcp-server-ableton = self.packages.${final.stdenv.hostPlatform.system}.default;
    };
    ...
    packages = forAllSystems ({
      ...
      meta = {
        description = "Rust MCP server for Ableton Live";
        license = pkgs.lib.licenses.gpl3Plus;
        mainProgram = "mcp-server-ableton";
      };
    in {
